...
DEV = './data/dev.data'
MODEL = './src/tmp/depModel1/model.ckpt'
CHECK = './src/tmp/depModel1/checkpoint'
GRPAH = './src/tmp/depModel1/model.ckpt.meta'
...
class depModel():
	...
	def hiddenLayer_1(self, x, hid_dim = 200):
	...
	def hiddenLayer_2(self, x, hid_dim = 200):
